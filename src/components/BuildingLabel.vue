  ...
  <div class="container" :class="isHover ? 'container_style_large' : 'container_style_small'"
    ...
    >
      <div
        ...
        :key="index"
        class="arrow_item"
        :style="{ backgroundImage: `url(${arrowPicSrc})` }"
      ></div>
      <div
        class="arrow_item_line"
        :style="{ backgroundImage: `url(${arrowItemLine})` }"
      ></div>
      <div
        class="arrow_item"
        :style="{ backgroundImage: `url(${arrowPicSrc})` }"
...
const props = defineProps({
  ...
  // arrowItemLine: {
  //   type: String,
  //   default: "@/assets/icon/电镀锌弹框线.png",
  // },
  toolTipBg: {
    type: String,
    default: "",
  ...
  videoSrcPress: {
    type: String,
    default: "@/assets/icon/gaoluarrowpress.png",
  },
  name: {
    type: String,
    required: true,
