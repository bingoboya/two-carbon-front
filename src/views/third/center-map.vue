        ...
        <div class="item_wrap" style="position: relative;">
          ...
          <div class="card_right">
            ...
            <div style="display: flex;">
              <div>同比</div>
              <div :style="{ color: true ? 'red' : 'green' }"
                style="display: flex; align-items: center;gap: 4px; padding-left: 8px;">
...
const gogogo = (buildingName: any) => {
  console.log('gogogo', buildingName);
  emits('handlePopupClick', buildingName);
}
