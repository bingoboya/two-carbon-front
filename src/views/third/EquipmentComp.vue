              ...
              <div style="width: 100%; height: 100%; display: flex; flex-direction: column; gap: 6px;">
                  <div class="params_wrapper" >
                      ...
                      <div class="params_wrap" >
                          <div class="params_item" >
                            <div class="temp_item"><div>150</div><div>°C</div></div>
                            <div>温度</div>
                          </div>
                          <div class="params_item" >
                            <div class="temp_item"><div>150</div><div>分钟</div></div>
                            <div>加热时间</div>
                          </div>
                  ...
                  <div class="my_table" >
                      ...
                      <vue3-seamless-scroll
                          ...
                          :hover="true"
                          :limitScrollNum="14"
                          class="scroll seamless-warp2 seamless"
                          :openWatch="true" 
                          :step="0.2"
                          :wheel="true"
                          :isWatch="true"
...
.params_wrapper{
padding: 4px; border: 2px solid; border-radius: 4px; flex: 1;display: flex;
  flex-direction: column;
}
.params_wrap {
height: 100%;    padding: 12px 2px;width: 100%; gap:4px; align-items: center; justify-content: space-around; display: flex; flex-direction: row;
}
.params_item {
flex: 1; display: flex;flex-direction: column;height: 100%;background-color: #454545a8;
justify-content: center;align-items: center;
}
.table_content_left{
flex: 15; text-align: center;padding: 6px 0;border-bottom: 1px solid #2ac8ee;
}
.table_content_center {
flex: 20; text-align: center;border: 1px solid #2ac8ee; border-top: none; padding: 6px 0;
}
.table_content_right {
flex: 30; text-align: center;padding: 6px 0;border-bottom: 1px solid #2ac8ee;
}

.scroll_item_left{
flex: 15; text-align: center;border-bottom: 1px solid #2ac8ee;padding: 6px 0;
}
.scroll_item_center{
flex: 20; text-align: center;border: 1px solid #2ac8ee; border-top: none; padding: 6px 0;
}
.scroll_item_right{
flex: 30; text-align: center;border-bottom: 1px solid #2ac8ee;padding: 6px 0;
}
